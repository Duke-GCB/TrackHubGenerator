...
bigbeds:
	...
	$(MAKE) -f Makefile.bigbed HUBROOT=$(HUBROOT) HG19_BEDFILES=$(DATA)/hg19/central20bp/E2F4 HG38_BEDFILES=HG19_BEDFILES=$(DATA)/hg38/central20bp/E2F4 FILE_PREFIX=E2F4
